...
The \enquote{\texttt{nodata}-aware} min-max normalization algorithm used for pre-processing elevation input data is:

\vspace{0.5em}
\fbox{
  \parbox{0.96\linewidth}{
    \vspace{0.5em}
    \textbf{Nodata-aware min-max normalization algorithm}
    \begin{enumerate}
