...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.66\linewidth]{metrics/lidar_metric_normalization+without_rgb-validation-iou}
  \caption{%
    Training procedure of U-Net LiDAR model using two different normalization methods.
...
\todo{Investigate when constant scaling beats dynamic scaling. Correlation with elevation range?}
\todo{Write about value of $\gamma$.}
