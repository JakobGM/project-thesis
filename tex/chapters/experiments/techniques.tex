...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.66\linewidth,trim={0 0.4cm 0 0},clip]{metrics/lidar_without_augment+without_rgb-validation-iou}
  \includegraphics[width=0.64\linewidth,trim={0 0.4cm 0 0.9cm},clip]{metric_correlation/without_rgb+lidar_without_augment+iou}
  \hspace{-0.9em}
  \caption{%
