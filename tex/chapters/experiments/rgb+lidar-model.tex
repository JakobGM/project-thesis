...
The median performing test prediction is shown in~\figref{fig:rgb-lidar-median}, most predictions show the same behaviour and weaknesses as the model based on solely LiDAR data.
...
In~\figref{fig:rgb-better-than-lidar} we presented two test tiles where the RGB model evaluated better than the LiDAR model.
...
The scatter plot in~\figref{fig:rgb-help} requires some explanation.
