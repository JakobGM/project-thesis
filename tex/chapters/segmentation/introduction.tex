...
\textit{Convolution neural networks} (CNNs) \unsure{are} one of the most successful techniques applied to image segmentation problems \cite[p.~1]{image_recognition}, and will be described in section \ref{sec:cnn}.
