...
State-of-the-art CNN architectures for image segmentation will be listed in~\secref{sec:cnn-architectures}, and existing work within the field of segmentation using remote sensing data is described in~\secref{sec:remote-sensing-research}.
