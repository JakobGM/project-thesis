A \textit{line string} is a ordered collection of geographic points $(\vec{p}_0, \ldots, \vec{p}_n)$ defining a path that connects each consecutive point by a straight line.
